...
public class AccountController {
    ...
    public ResponseEntity<ApiResponse<List<AccountResponse>>> getAllAccounts() {
        ...
        return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK.value(), accountResponses, "success"));
    }
    ...
    public ResponseEntity<ApiResponse<AccountResponse>> getAccount(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK.value(), accountResponse, "success"));
    }
    ...
    public ResponseEntity<ApiResponse<AccountResponse>> updateAccount(@PathVariable Long id, @RequestBody RegisterDto request) {
        ...
        return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK.value(), accountResponse, "updated"));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteAccount(@PathVariable Long id) {
        ...
        ApiResponse<Void> apiResponse =
                ApiResponse.success(HttpStatus.OK.value(), null, "deleted");
