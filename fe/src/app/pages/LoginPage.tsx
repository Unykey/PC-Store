    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6">
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left Side - Benefits */}
          <div className="bg-gradient-to-br from-[#0066b3] to-[#004d85] rounded-lg p-8 text-white hidden md:block">
            <h2 className="text-white mb-6">Chào Mừng Trở Lại</h2>
            <p className="text-white/90 mb-8">
              Đăng nhập để trải nghiệm mua sắm tuyệt vời và nhận được những ưu
              đãi độc quyền!
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">
                    Giảm giá và khuyến mãi dành riêng cho thành viên
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">
                    Quản lý đơn hàng và lịch sử mua hàng dễ dàng
                  </p>
                </div>
              </div>
